...
See audio_samples/README.md. Supported formats: wav/mp3/flac/ogg/opus.
"""
from amazing_hand_audio import (
    AUDIO_EXTS,
    AUDIO_SAMPLES_DIR,
    POSE_VOCAB,
    match_command,
...
pytestmark = pytest.mark.skipif(
    not _FILES,
    reason="no recordings in audio_samples/ (drop some audio files to enable)",
)
